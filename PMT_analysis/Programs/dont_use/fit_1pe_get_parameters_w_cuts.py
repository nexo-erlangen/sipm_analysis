...
def main():
	...
	sigma1_limit_list = [ [ 4.2, 4.3, 3.9, 4.6 ], [ 5.5, 5.3, 5.2 ], [4.5, 5.2, 4.8], [ 4.9, 4.8, 4.6, 4.5 ] ]
...
def fit_histogram(run_number, Q1_value, sigma1_limit):
	path = "/home/vault/capm/sn0527/PMT_LED_Temp/Run" + run_number + "/"
	file = "datatree.root"
	...
	f.SetParLimits(1,Q1_value,15);
	#f.FixParameter(1, 8.9);
	f.SetParName(1, "Q_1");
	f.SetParameter(2,3.386); # sigma of 1 pe (?)
	f.SetParLimits(2,0.5,sigma1_limit);
