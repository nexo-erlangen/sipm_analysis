...
def main():
	...
	sigma1_limit_list = [ [ 4.1, 4.2, 3.9, 4.2 ], [ 4.7, 4.8, 5.1 ], [4.9, 4.6, 4.8], [ 4.3, 4.2, 4.6, 4.5 ] ]
	...
	for j in range(4):
		...
		with open( "/home/vault/capm/sn0527/PMT_LED_Temp/Auswertung_1sigma_cut_final/parameter_T=%sC_1sig_cut.txt" % (Temp_list[j]  ), "w" ) as plotfile:
			...
			for i in range(len(run_list[j])):
				...
				print "\n"
				parameters = ""
				os.system( "python /home/vault/capm/sn0527/PMT_LED_Temp/Auswertung_1sigma_cut_final/fit_1pe_single_res_one_cut.py --file /home/vault/capm/sn0527/PMT_LED_Temp/Run%s/fit_tree_1_sigma.root -q %f -s %f -c %s" %(  run_list[j][i], Q1_value[j], sigma1_limit_list[j][i], "1_sigma_cut" )  )
				os.system( "cp /home/vault/capm/sn0527/PMT_LED_Temp/Run%s/pmt_1pe_test_sigma_res_1sig_cut_orig_final.pdf /home/vault/capm/sn0527/PMT_LED_Temp/Auswertung_1sigma_cut_final/pmt_1pe_Run%s_1sig_cut.pdf" %( run_list[j][i], run_list[j][i] ) )
				print "--------------------------- copy pdf ---------------------------"
